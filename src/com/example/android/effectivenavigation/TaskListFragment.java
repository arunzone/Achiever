...
public class TaskListFragment extends ListFragment implements LoaderCallbacks<Cursor> {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		taskType = getArguments() != null ? getArguments().getInt("taskType") : 1;
		getLoaderManager().initLoader(taskType, null, this);
	}
	...
	public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
		...
		return new CursorLoader(getActivity(), CONTENT_URI, ALL_COLUMNS, TASKS_TABLE_COLUMN_TASKTYPE + "="
				+ taskType, null, null);
	}
